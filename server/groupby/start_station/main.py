...
NAME_SEND_EXCHANGE = os.environ.get("NAME_SEND_EXCHANGE")
...
def main():
    g = GroupbyStartStation(NAME_RECV_QUEUE, NAME_EM_QUEUE, NAME_SEND_EXCHANGE, NAME_SEND_QUEUE, SIZE_WORKERS_SEND, CHUNK_SIZE)
    g.stop()
