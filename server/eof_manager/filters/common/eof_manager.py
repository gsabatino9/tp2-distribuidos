...
class EOFManager:
    ...
    def __send_eofs(self, header, msg):
        ...
        for i, filter_queue in enumerate(self.filters_queues):
            filter_queue.broadcast_workers(self.size_workers[i], msg)
