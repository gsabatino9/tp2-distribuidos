...
class LeaderElection:
    def __init__(
        ...
        self.leader_alive = LeaderAlive(
            self.my_id, self.control_sender, self.election_starter
        )
        self.control_receiver = ControlReceiver(
            my_id,
            self.middleware,
            self.election_starter,
            self.control_sender,
            self.leader_alive,
            stop_leader_actions_callback,
            i_am_leader_callback,
